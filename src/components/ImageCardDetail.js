...
const ImageCardDetail = () => {
  ...
  return (
    <div class='relative w-full h-auto py-4 px-7'>
        ...
        <div>
          <div class='grid grid-cols-2 py-1'>
            ...
            <div class='justify-self-end px-9'>
              <button class="mx-2 my-1 md:my-0 px-6 py-2 font-semibold text-xl rounded text-white bg-amber-500 hover:bg-amber-600 duration-500 inline-block" onClick={clicked}>
                Investir
              </button>
            </div>
          </div>
